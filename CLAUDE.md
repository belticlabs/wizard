...
- **CHANGELOG Updates**: Always update CHANGELOG.md when making user-facing changes.
...
2. Add detection logic for new framework
...
2. Update Claude API calls in `src/beltic/yaml-generator.ts`
